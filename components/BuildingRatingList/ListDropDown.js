...
export default function DropDown({ ratingDatas }) {
  ...
  return (
    <List>
      ...
      <div style={{ display: displayRatings ? "block" : "none" }}>
        {CoHoDorms.map((d, index) => (
          <div key={index}>
            ...
            >
              <Link href={"/coho/" + d.path} underline="always" sx={linkStyle}>
                {d.label}
              </Link>
              {d.unit ? (
                <KeyboardArrowDown
                ...
                <div>?</div>
                // <RatingDisplay data={ratingDatas[d.label]} />
              )}
            </ListItemButton>
                ...
                {d.unit.map((u) => (
                  <List key={u.label + index} component="div" disablePadding>
                    ...
                    >
                      ...
                      {/* <RatingDisplay data={ratingDatas[d.label][u.label]} /> */}
                    </ListItemButton>
                  </List>
                ))}
              </Collapse>
