"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[315],{3871:function(e,t,r){r.d(t,{B:function(){return signOut},a8:function(){return createUserWithEmailAndPassword},a9:function(){return signInWithEmailAndPassword},ae:function(){return sendEmailVerification},o:function(){return getAuth},x:function(){return onAuthStateChanged}});var i,n=r(8745),s=r(3991),a=r(44),o=r(6914),l=r(5538);function _prodErrorMap(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let c=new n.LL("auth","Firebase",_prodErrorMap()),u=new o.Yd("@firebase/auth");function _logError(e,...t){u.logLevel<=o.in.ERROR&&u.error(`Auth (${s.Jn}): ${e}`,...t)}/**
 * @license
